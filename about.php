						...
						<!-- logo -->
							...
							<nav class="main-menu" align="right">
								<ul>
									...
									<li class="current-list-item"><a href="http://localhost/DAW/about.php">Despre Noi</a></li>
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="breadcrumb-text">
						<p>Colecțiile tale sunt în siguranță</p>
						<h1>Despre Noi</h1>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">
						<h3>Echipa <span class="orange-text">Noastră</span></h3>
						<p>Succesul este efortul în echipă.</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="single-team-item">
						...
						<h4>Bejan Elena <span>Data-base</span></h4>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-team-item">
						...
						<h4>Barîmb Eusebiu <span>Back-end</span></h4>
						<ul class="social-link-team">
							<li><a href="#" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
							<li><a href="#" target="_blank"><i class="fab fa-instagram"></i></a></li>
						</ul>
				...
				<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
					<div class="single-team-item">
						...
						<h4>Albot Elena <span>Front-End</span></h4>
						<ul class="social-link-team">
							<li><a href="#" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
							<li><a href="#" target="_blank"><i class="fab fa-instagram"></i></a></li>
						</ul>
