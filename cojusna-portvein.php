...
<body>
	...
	<div class="single-product mt-150 mb-150">
		<div class="container" id="cojusna-portvein">
			<div class="row">
				<div class="col-md-5">
					<div class="single-product-img">
						<img src="assets/img/products/cojusna-portvein.png" alt="">
					</div>
				</div>
				<div class="col-md-7">
					<div class="single-product-content">
						<table style="width:100%">
						  ...
						  <p>
						  Vin de colectie din soiul de strugure selectionat Rkatsiteli. Vinurile de colectie te incinta cu aromele sale de fructe uscate confiate, si arome florale. Pe sticla este indicat anul recoltei, la fel si anul cit a fost maturat in butoi.Un cadou perfect pentru un colectioner adevarat de vinuri. 
						  </p>
					</div>
				</div>
			</div>
