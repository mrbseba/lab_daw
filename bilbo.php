...
<body>
	...
	<div class="single-product mt-150 mb-150">
		<div class="container" id="bilbo">
			<div class="row">
				<div class="col-md-5">
					<div class="single-product-img">
						<img src="assets/img/products/bilbo.jpg" alt="">
					</div>
				</div>
				<div class="col-md-7">
					<div class="single-product-content">
						<table style="width:100%">
							...
							<tr>
								<td>Material:</td>
								<td>Metal, ipsos, plastic sau derivate din acestea</td>
							</tr>
						  ...
						  <p>
						  Fiecare piesa din colectie reprezinta un personaj din "Lord of The Rings"
					<br> Materiale folosite: Metal, ipsos, plastic sau derivate din acestea
					<br> Piesele sunt pictate manual
					<br> Figurina este protejata intr-un blister de plastic, specific figurinelor
						  </p>
					</div>
				</div>
			</div>
