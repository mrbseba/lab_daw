...
<body>
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="breadcrumb-text">
						<h1>100 de ani de la Unirea Basarabiei cu România (argint)</h1>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="single-product mt-150 mb-150">
		<div class="container" id="100-ani-argint">
			<div class="row">
				<div class="col-md-5">
					<div class="single-product-img">
						<img src="assets/img/products/100-ani-argint.jpg" alt="">
					</div>
				</div>
				<div class="col-md-7">
